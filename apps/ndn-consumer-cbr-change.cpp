...
#include "ndn-consumer-cbr-change.hpp"
#include "ns3/ptr.h"
#include "ns3/log.h"
...
NS_LOG_COMPONENT_DEFINE("ndn.ConsumerCbrChange");

namespace ns3 {
namespace ndn {

NS_OBJECT_ENSURE_REGISTERED(ConsumerCbrChange);

TypeId
ConsumerCbrChange::GetTypeId(void)
{
  static TypeId tid =
    TypeId("ns3::ndn::ConsumerCbrChange")
      ...
      .AddAttribute("Randomize",
                    ...
                    StringValue("none"),
                    MakeStringAccessor(&ConsumerCbrChange::SetRandomize, &ConsumerCbrChange::GetRandomize),
                    MakeStringChecker())
...
ConsumerCbrChange::ConsumerCbrChange()
  : m_frequency(1.0)
  , m_firstTime(true)
  , m_random(0)
{
...
void
ConsumerCbrChange::ScheduleNextPacket()
{
...
void
ConsumerCbrChange::SetRandomize(const std::string& value)
{
  if (m_random)
    delete m_random;
...
std::string
ConsumerCbrChange::GetRandomize() const
{
  return m_randomType;
}
} // namespace ndn
