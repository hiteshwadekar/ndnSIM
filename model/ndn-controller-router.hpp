...
public:
  ...
  typedef std::tuple<Ptr<ControllerRouter>,shared_ptr<size_t>, Ptr<ControllerRouter>, size_t> Incidency;
  /**
   ...
   */
  void
  AddIncidency(shared_ptr<size_t> faceId, Ptr<ControllerRouter> ndn, size_t faceMetric);
  /**
