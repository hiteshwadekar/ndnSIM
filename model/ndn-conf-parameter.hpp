#ifndef NDN_CONF_PARAMETER_HPP
#define NDN_CONF_PARAMETER_HPP
...
public:
  ...
  void
  setNetwork(const Name& networkName)
  {
  ...
  void
  setRouterName(const Name& routerName)
  {
